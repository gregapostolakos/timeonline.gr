<?php echo $header; ?>
<div id="content">
    <style>#menu > ul li li a {font-size:12px;width:155px;}.order-table td{vertical-align:middle!important}</style>
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
        		...
        		<?php } ?>
                <button type="submit" form="form-tagmanager" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i><?php echo $button_save;?></button>
                <button type="submit" name ="apply" value="1" form="form-tagmanager" data-toggle="tooltip" title="<?php echo $button_apply; ?>" class="btn btn-success"><i class="fa fa-check"></i><?php echo $button_apply; ?></button>
