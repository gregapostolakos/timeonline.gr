...
$_['text_home']                = 'Home';
$_['text_success']             = 'Success: You have modified the Meta Catalog feed!';
...
$_['copyright_body']           = 'Meta Catalog Feed for OpenCart, developed by Webartstudio. This extension is licensed for use on the store it was installed on.';
...
$_['column_availability']      = 'Meta availability';
$_['column_name']              = 'Name';
...
// Help
$_['help_mask']                = 'Clean filename/path after the domain (e.g. "meta.xml"). Leave empty to use the default route URL.';
...
$_['help_strip_html']          = 'Meta does not allow HTML in fields. Recommended: Yes.';
...
$_['help_availability_map']    = 'For out-of-stock items, map each OC stock status to a Meta value (or exclude the product).';
...
// Error
$_['error_permission']         = 'Warning: You do not have permission to modify the Meta Catalog feed!';
