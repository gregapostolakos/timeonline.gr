...
<p>SEO titles are not automatically applied to your theme because this will be changing your design, so you have to manually insert them in your themplates.<br/><br/>Files to modify (.tpl or .twig):<br/><code style="padding:0">/catalog/view/theme/[theme]/template/common/home<br/>/catalog/view/theme/[theme]/template/product/product<br/>/catalog/view/theme/[theme]/template/product/category<br/>/catalog/view/theme/[theme]/template/information/information<br/>/catalog/view/theme/[theme]/template/product/manufacturer_info</code><br/><br/>Insert these codes for .tpl (please note $heading_title is automatically containing $seo_h1, so it is generally not necessary to put seo h1, just h2 and h3): <br/><code style="padding:0">&lt;h1&gt;&lt;?php echo $seo_h1; ?&gt;&lt;/h1&gt;<br/>&lt;h2&gt;&lt;?php echo $seo_h2; ?&gt;&lt;/h2&gt;<br/>&lt;h3&gt;&lt;?php echo $seo_h3; ?&gt;&lt;/h3&gt;</code><br/><br/>Or these codes for .twig  (please note {{ heading_title }} is automatically containing {{ seo_h1 }}, so it is generally not necessary to put seo h1, just h2 and h3): <br/><code style="padding:0">&lt;h1&gt;{{ seo_h1 }}&lt;/h1&gt;<br/>&lt;h2&gt;{{ seo_h2 }}&lt;/h2&gt;<br/>&lt;h3&gt;{{ seo_h3 }}&lt;/h3&gt;</code><br/></p>
...
$_['text_gg_enhanced'] = 'Google Enhanced eCommerce Tracking';
$_['text_gg_adwords'] = 'Google Adwords';
$_['entry_analytics_code'] = 'Google Analytics ID:<span class="help">It is ID in this format: UA-12345678-9</span>';
...
$_['text_info_analytics'] = '<h4>Set up Google Analytics</h4>
<p>You can have detailled information of your website SEO using Google Analytics and Enhanced eCommerce Tracking, for that connect to <a href="https://analytics.google.com">https://analytics.google.com</a> and register your website, then see images below for next steps.</p>
...
$_['text_seo_generator_category_desc']	= '<strong>Main</strong><br/><b>[name]</b> Category name<br/><b>[desc]</b> Description extract<br/><b>[desc_sentence]</b> 1st sentence<br/><b>[parent]</b> Parent category name<br/><b>[child]</b> Child category name<br/><b>[lowest_price]</b> Lowest product price<br/><b>[highest_price]</b> Highest product price<br/><br/>'.$special_tags;
