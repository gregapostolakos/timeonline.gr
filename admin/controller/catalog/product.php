...
class ControllerCatalogProduct extends Controller
{
	...
	public function add()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->get['filter_weight_min'])) {
				$url .= '&filter_weight_min=' . $this->request->get['filter_weight_min'];
			}

			if (isset($this->request->get['filter_weight_max'])) {
				$url .= '&filter_weight_max=' . $this->request->get['filter_weight_max'];
			}
	...
	protected function getList()
	{
		...
		if (isset($this->request->get['filter_weight_min'])) {
			$filter_weight_min = $this->request->get['filter_weight_min'];
		} else {
			$filter_weight_min = '';
		}
		if (isset($this->request->get['filter_weight_max'])) {
			$filter_weight_max = $this->request->get['filter_weight_max'];
		} else {
			$filter_weight_max = '';
		}
		...
		$filter_data = array(
			...
			'filter_weight_min'	  	=> $filter_weight_min,
			'filter_weight_max'		=> $filter_weight_max,
		...
		$data['sort_price'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=active_price' . $url, true);
		...
		$data['filter_weight_min'] = $filter_weight_min;
		$data['filter_weight_max'] = $filter_weight_max;
	...
	public function autocomplete()
	{
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model']) || isset($this->request->get['filter_sku']) || isset($this->request->get['filter_ean'])) {
			$this->load->model('catalog/product');
			$this->load->model('catalog/option');
