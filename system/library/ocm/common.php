...
final class Common {
    ...
    public function __construct($registry) {
        ...
        $this->customConfig["dataPrefix"] = VERSION >= '4.0.0.0' ? 'data-' : 'data-';
    ...
    public function setCustomConfig() {
        ...
        if (file_exists(dirname(__FILE__) . "/ocm.json")) {
            $json = @file_get_contents(dirname(__FILE__) . "/ocm.json");
            ...
            if (is_array($props)) {
                ...
                $this->log->write("Invalid JSON file ocm.json");
            }
        }
    }
    public function getCustomConfig($key) {
        return !empty($this->customConfig[$key]) ? $this->customConfig[$key] : '';
    }
}