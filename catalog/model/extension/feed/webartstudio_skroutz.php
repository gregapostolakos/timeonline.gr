<?php
/**
 * Skroutz XML Feed — catalog model (front-end queries only).
 *
 * All filtering is driven by the settings array passed in; nothing is
 * site-specific. Whitelisted column names guard the dynamic field mapping.
 */
